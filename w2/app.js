...
showOnPage('<================================================>');
showOnPage(
  '//Here is a local variable, the value is determined by the global inputs.'
);
showOnPage('<================================================>');
...
showOnPage('<================================================>');
showOnPage(
  '<b>Here is the final output of the program based on all the conditions:</b>'
);
